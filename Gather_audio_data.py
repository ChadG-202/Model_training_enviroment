...
class Audio_recorder:
    ...
    def Recording(self, type, pos):
        ...
        def Save():
            if self.test_set:
                wf = wave.open("Data/Test/Pre/Audio/test.wav", 'wb')
...
#Audio_recorder(tk.Tk(), 'Audio Recorder', 100, False)
Audio_recorder(tk.Tk(), 'Audio Recorder', 30, False)